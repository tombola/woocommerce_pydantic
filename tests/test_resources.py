...
WC_API_VERSION = os.environ.get("TEST_WC_URL", "http://example.com")
WC_API_URL = f"{WC_URL}/wp-json/{WC_API_VERSION}"
WC_API_KEY = os.environ.get("TEST_WC_KEY", "ck_XXXXXXXX")
WC_API_SECRET = os.environ.get("TEST_WC_SECRET", "cs_XXXXXXXX"),
...
# CURRENT_DIRECTORY = Path.parent(Path.resolve(__file__)
